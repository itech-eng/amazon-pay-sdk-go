...
```sh
go get github.com/itech-eng/amazon-pay-sdk-go
```

## Usage

```go
import amazonpay "github.com/itech-eng/amazon-pay-sdk-go"
...
After placed orders, you can manage them via [our admin interface]((https://demo.getqor.com/admin)), like `take auth`, `capture`, `refund` orders, the admin interface is generated with [QOR Admin](http://github.com/itech-eng/admin)

#### Source code of this demo

[https://github.com/itech-eng/qor-example](https://github.com/itech-eng/qor-example)
